 ...
 *
 * @param <W> The wrapper type (e.g. MooPlayer)
 * @param <T> The wrapped type (e.g. PlayerData)
 */
public abstract class ObjectWrapper<W, T> {

    /**
     * The wrapped object accessable with {@link #unwrap()}
     */
