...
public enum DbModifier {
    ...
    PLAYER_LAST_ONLINE(4, PlayerData.class),
    PLAYER_FIRST_ONLINE(5, PlayerData.class),
    PLAYER_TOTAL_ONLINE(6, PlayerData.class),
    PLAYER_JOINED(7, PlayerData.class),
    PLAYER_EXTRA_PERMS(8, PlayerData.class, Validation.PERMISSION),
    PLAYER_COINS(9, PlayerData.class),
    PLAYER_BANPOINTS(10, PlayerData.class, Validation.INTEGER),
